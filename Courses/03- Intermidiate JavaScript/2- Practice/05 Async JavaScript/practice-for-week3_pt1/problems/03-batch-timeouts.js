...
function batchTimeouts(callbacks, delays) {
   // Initialize an empty array to store the Timeout objects
   const timeoutObjs = [];

   // Iterate over the callbacks and delays arrays
   for (let i = 0; i < callbacks.length; i++) {
     // Set a timeout for each callback with its corresponding delay
